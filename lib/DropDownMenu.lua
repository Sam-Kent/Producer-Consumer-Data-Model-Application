...
local cDefaultButtonValue       = "Generate Graph data"
...
function DropDownMenu.new( params )
    ...
    button = display.newRect(dropDownMenu, -1, -1+50, buttonWidth, buttonHeight)
    ...
    buttonLabel.y = (buttonHeight * 0.5) - (fontSize * 0.5)-18+50
